...
participation_2021 <- readRDS(here("data/or_apcs_202021.rds"))
ecosystem_2122 <- readRDS(here("data/or_cs_eco_2122.rds"))
...
# save as RDS
saveRDS(cs_state_long, "data/nat_degrees_long.rds")
...
saveRDS(cs, "data/nat_cs_trends.rds")
